...
Writes raw JSON responses to tests/givingtuesday_990/sample_990_api_output/ and a combined
sample CSV to tests/givingtuesday_990/sample_990_api_output/sample_990_basic120.csv.

Run from repo root: python tests/givingtuesday_990/test_fetch_990_givingtuesday.py
"""
...
# Same endpoint as python/ingest/givingtuesday_990/api/04_fetch_givingtuesday_990.py
