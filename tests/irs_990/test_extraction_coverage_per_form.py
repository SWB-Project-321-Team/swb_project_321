...
Run from repo root:
  python tests/irs_990/test_extraction_coverage_per_form.py
  python tests/irs_990/test_extraction_coverage_per_form.py --s3 --per-type 3
...
PARSER_SCRIPT = _REPO_ROOT / "python" / "ingest" / "irs_990" / "03_parse_irs_990_zips_to_staging.py"
