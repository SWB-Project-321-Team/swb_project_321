...
> **Status reviewed 2026-07-23:** this remains the project scope and variable-planning reference. Implemented mappings and availability are maintained in `docs/deliverables/preprocessing/technical_reference/`.
