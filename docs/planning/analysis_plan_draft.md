...
> **Artifact status reviewed 2026-07-23:** this is the retained planning baseline, not the authoritative implementation guide. Use current pipeline references and the final-report workflow for implemented behavior.
