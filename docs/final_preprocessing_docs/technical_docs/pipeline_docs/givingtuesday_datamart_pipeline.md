...
- Analysis data dictionary: use `docs/final_preprocessing_docs/technical_docs/analysis_variable_mappings/givingtuesday_basic_analysis_variable_mapping.md` plus `SWB_321_DATA_ROOT/raw/givingtuesday_990/datamarts/metadata/givingtuesday_990_basic_allforms_analysis_variable_coverage.csv`; raw dictionary support is under `documentation/final_preprocessing_docs/technical_docs/source_dictionaries/givingtuesday_datamarts/` (repository clone: `docs/final_preprocessing_docs/technical_docs/source_dictionaries/givingtuesday_datamarts/`).
...
- Published S3 documentation object: `silver/givingtuesday_990/analysis/documentation/givingtuesday_datamart_pipeline.md`
...
- `docs/final_preprocessing_docs/technical_docs/analysis_variable_mappings/`
