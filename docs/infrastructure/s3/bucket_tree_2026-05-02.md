...
> **Last confirmed historical snapshot:** the bucket was intentionally deleted by 2026-07-23. This tree describes its 2026-05-02 state and must not be used to recreate the bucket.
...
- Associated classified inventory: `docs/infrastructure/audits/s3_object_inventory_classification_2026-05-02.csv`
- Former final preprocessing documentation package: `documentation/final_preprocessing_docs/` (111 objects)

## Snapshot Analysis Documentation Layout
...
These prefix counts were generated from the 2026-05-02 object inventory and show the first two path components.
...
- Historical row-level inventory in `docs/infrastructure/s3/bucket_inventory_2026-03-22.md` remains a 2026-03-22 snapshot; use the classified CSV above for the last confirmed 2026-05-02 object list.
