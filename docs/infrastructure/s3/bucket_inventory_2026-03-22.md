...
> **Historical snapshot:** the bucket was intentionally deleted by 2026-07-23. This inventory describes its 2026-03-22 state and must not be used to recreate the bucket.
...
For the **last confirmed prefix layout**, see `docs/infrastructure/s3/bucket_tree_2026-05-02.md`. The 2026-05-02 listing recorded **489** objects and **35,711,714,691** bytes. Its associated classified inventory is `docs/infrastructure/audits/s3_object_inventory_classification_2026-05-02.csv`; the former published documentation prefix was `documentation/final_preprocessing_docs/`. This file remains the 2026-03-22 row-level snapshot.
