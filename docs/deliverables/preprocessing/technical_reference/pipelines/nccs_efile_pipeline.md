...
- Mapping doc: `docs/deliverables/preprocessing/technical_reference/variable_mappings/nccs_efile_analysis_variable_mapping.md`
- Data-processing doc: `docs/deliverables/preprocessing/technical_reference/pipelines/nccs_efile_pipeline.md`
...
- Former published S3 documentation object (historical): `silver/nccs_efile/analysis/documentation/nccs_efile_pipeline.md`
- Former published S3 variable mapping object (historical): `silver/nccs_efile/analysis/variable_mappings/nccs_efile_analysis_variable_mapping.md`
- Former published S3 coverage object (historical): `silver/nccs_efile/analysis/quality/coverage/nccs_efile_analysis_variable_coverage.csv`
