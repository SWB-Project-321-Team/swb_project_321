...
- Mapping Markdown: `docs/deliverables/preprocessing/technical_reference/variable_mappings/irs_bmf_analysis_variable_mapping.md`
- Data-processing Markdown: `docs/deliverables/preprocessing/technical_reference/pipelines/irs_bmf_pipeline.md`
...
- Former published S3 documentation object (historical): `silver/irs990/bmf/analysis/documentation/irs_bmf_pipeline.md`
- Former published S3 variable mapping object (historical): `silver/irs990/bmf/analysis/variable_mappings/irs_bmf_analysis_variable_mapping.md`
- Former published S3 coverage object (historical): `silver/irs990/bmf/analysis/quality/coverage/irs_bmf_analysis_variable_coverage.csv`
