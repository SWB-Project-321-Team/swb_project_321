...
- Local raw CSV directory: `data/321_Black_Hills_Area_Community_Foundation_2025_08/01_data/raw/nccs_efile/raw`
- Local metadata directory: `data/321_Black_Hills_Area_Community_Foundation_2025_08/01_data/raw/nccs_efile/metadata`
- Local staging directory: `data/321_Black_Hills_Area_Community_Foundation_2025_08/01_data/staging/nccs_efile`

### Analysis artifacts

- Row-level analysis parquet: `data/321_Black_Hills_Area_Community_Foundation_2025_08/01_data/staging/nccs_efile/nccs_efile_analysis_variables.parquet`
- Region metrics parquet: `data/321_Black_Hills_Area_Community_Foundation_2025_08/01_data/staging/nccs_efile/nccs_efile_analysis_geography_metrics.parquet`
- Coverage CSV: `data/321_Black_Hills_Area_Community_Foundation_2025_08/01_data/raw/nccs_efile/metadata/nccs_efile_analysis_variable_coverage.csv`
- Mapping doc: `docs/analysis/nccs_efile_analysis_variable_mapping.md`
- Data-processing doc: `docs/data_processing/nccs_efile_pipeline.md`
