# IRS SOI exploration notebook documentation

**Documentation reviewed:** 2026-07-23. The active repository notebook is [`../../notebooks/03_irs_soi_exploration.ipynb`](../../notebooks/03_irs_soi_exploration.ipynb); the retained source files represent tax year 2022.
