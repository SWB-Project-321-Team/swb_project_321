# USAspending exploration notebook documentation

**Documentation reviewed:** 2026-07-23. The active repository notebook is [`../../notebooks/04_usaspending_exploration.ipynb`](../../notebooks/04_usaspending_exploration.ipynb); the raw-export path below identifies the retained 2026-03-29 source snapshot.
