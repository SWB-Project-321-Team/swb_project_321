...
Run from repo root. Loads secrets/.env for AWS.
  ...
  python scripts/diagnostics/irs_990/verify_index_irs_vs_s3.py
  python scripts/diagnostics/irs_990/verify_index_irs_vs_s3.py --start-year 2022 --end-year 2024
"""
