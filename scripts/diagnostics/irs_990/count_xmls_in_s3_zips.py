...
Run from repo root:
  python scripts/diagnostics/irs_990/count_xmls_in_s3_zips.py
  python scripts/diagnostics/irs_990/count_xmls_in_s3_zips.py --year 2024
  python scripts/diagnostics/irs_990/count_xmls_in_s3_zips.py --year 2024 --max-zips 2
"""
import os
import sys
import zipfile
...
# Reuse 03's list and filter (source in python/ingest/irs_990/)
