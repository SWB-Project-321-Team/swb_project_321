...
Usage (from repo root):
  python scripts/diagnostics/irs_990/benchmark_parser_one_xml.py
  python scripts/diagnostics/irs_990/benchmark_parser_one_xml.py --xml path/to/file.xml
  python scripts/diagnostics/irs_990/benchmark_parser_one_xml.py --rounds 100
"""
