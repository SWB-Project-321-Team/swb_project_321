...
Run from repo root: python scripts/diagnostics/irs_990/validate_parser_by_form_type.py
"""
...
PARSER_PATH = REPO_ROOT / "python" / "ingest" / "irs_990" / "03_parse_irs_990_zips_to_staging.py"
