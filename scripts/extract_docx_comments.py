...
def main() -> None:
    repo = Path(__file__).resolve().parents[1] / "docs" / "final_report"
    targets = sys.argv[1:] or [
        "Philanthropic characteristics of the Black Hills Area and co (UPDATED).docx",
        "Philanthropic characteristics of the Black Hills Area and co color-coded.docx",
    ]
    for name in targets:
