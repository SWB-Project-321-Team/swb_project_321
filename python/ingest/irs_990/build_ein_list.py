"""
Build the EIN list for benchmark regions for the irs_990 pipeline.
...
and the ZIP-to-county crosswalk. Output is reference only; the pipeline filters by geography (03/04), not by this EIN list (no dependency on givingtuesday_990).
...
# BMF CSVs by state (irs_990 00_fetch_bmf.py).
