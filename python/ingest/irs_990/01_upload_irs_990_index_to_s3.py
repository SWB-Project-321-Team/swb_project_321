...
Override via: --bucket, --prefix, --region. Defaults: bucket/prefix from docs/data_sources/irs_990/irs_990_teos_s3_plan.md.

Run from repo root:
  python python/ingest/irs_990/01_upload_irs_990_index_to_s3.py
  python python/ingest/irs_990/01_upload_irs_990_index_to_s3.py --start-year 2021 --end-year 2026
  python python/ingest/irs_990/01_upload_irs_990_index_to_s3.py --workers 4
"""
