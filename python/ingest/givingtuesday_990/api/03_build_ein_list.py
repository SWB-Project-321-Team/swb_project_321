...
Run from repo root: python python/ingest/givingtuesday_990/api/03_build_ein_list.py

See docs/data_sources/irs_990/990_data_fetch_plan.md for how to obtain BMF and zip-to-county data.
"""
