# givingtuesday_990/datamart

> **Infrastructure status (2026-07-23):** local/public-source processing remains documented, but the former project S3 bucket was intentionally deleted. Upload and local/S3 verification steps are historical and must not recreate `swb-321-irs990-teos`.
...
- This pipeline is self-contained in `python/ingest/givingtuesday_990/datamart/`.
- It does **not** read code outputs from `givingtuesday_990/api` or `irs_990` pipelines.
...
```powershell
python python/ingest/givingtuesday_990/datamart/01_fetch_datamart_catalog.py
python python/ingest/givingtuesday_990/datamart/02_export_data_dictionary.py
python python/ingest/givingtuesday_990/datamart/03_download_raw_datamarts.py
python python/ingest/givingtuesday_990/datamart/04_upload_bronze_raw_and_dictionary.py
python python/ingest/givingtuesday_990/datamart/05_verify_source_local_s3_sizes.py
python python/ingest/givingtuesday_990/datamart/06_build_basic_allforms_presilver.py
python python/ingest/givingtuesday_990/datamart/07_build_basic_plus_combined_presilver.py
python python/ingest/givingtuesday_990/datamart/08_filter_benchmark_outputs_local.py
python python/ingest/givingtuesday_990/datamart/09_upload_bronze_presilver_outputs.py
python python/ingest/givingtuesday_990/datamart/10_upload_silver_filtered_outputs.py
python python/ingest/givingtuesday_990/datamart/11_verify_curated_outputs_local_s3.py
python python/ingest/givingtuesday_990/datamart/13_extract_basic_analysis_variables_local.py
python python/ingest/givingtuesday_990/datamart/14_upload_analysis_outputs.py
```
...
```powershell
python python/ingest/givingtuesday_990/datamart/run_990_datamart_pipeline.py --start-step 1 --end-step 5 --overwrite-download --refresh-catalog
python python/ingest/givingtuesday_990/datamart/run_990_datamart_pipeline.py --bucket swb-321-irs990-teos --region us-east-2 --tax-year-min 2022 --tax-year-max 2024 --emit both
```
