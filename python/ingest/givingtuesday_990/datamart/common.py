...
_PYTHON_DIR = _THIS_FILE.parents[3]  # datamart -> givingtuesday_990 -> ingest -> python
...
DOCS_PACKAGE_DIR = get_base() / "docs" / "deliverables" / "preprocessing"
DOCS_TECHNICAL_DIR = DOCS_PACKAGE_DIR / "technical_reference"
DOCS_ANALYSIS_DIR = DOCS_TECHNICAL_DIR / "variable_mappings"
DOCS_DATA_PROCESSING_DIR = DOCS_TECHNICAL_DIR / "pipelines"
