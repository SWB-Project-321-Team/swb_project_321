...
- `docs/deliverables/preprocessing/technical_reference/variable_mappings/nccs_990_core_analysis_variable_mapping.md`
- `docs/deliverables/preprocessing/technical_reference/pipelines/nccs_990_core_pipeline.md`
