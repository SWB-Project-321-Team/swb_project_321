"""
Step 08: Upload NCCS Core analysis outputs and metadata to S3.
"""
...
def _upload_one(local_path: Path, bucket: str, region: str, key: str, overwrite: bool) -> dict[str, object]:
    ...
    return {"uploaded": uploaded, "local_size_bytes": local_size, "remote_size_bytes": remote_size}


def main() -> None:
    parser = argparse.ArgumentParser(description="Upload NCCS Core analysis outputs to S3.")
    ...
    banner("STEP 08 - UPLOAD NCCS CORE ANALYSIS OUTPUTS")
    load_env_from_secrets()
