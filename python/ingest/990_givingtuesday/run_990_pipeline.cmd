...
REM Usage: from repo root, run:  python\ingest\990_givingtuesday\run_990_pipeline.cmd
REM        or from anywhere:     "C:\Users\eilke\Desktop\Github Repo\swb_project_321\python\ingest\990_givingtuesday\run_990_pipeline.cmd"
setlocal
set "REPO_ROOT=%~dp0..\..\.."
cd /d "%REPO_ROOT%"
