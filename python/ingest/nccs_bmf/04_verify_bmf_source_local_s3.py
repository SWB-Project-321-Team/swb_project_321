"""
Step 04: Verify source/local/S3 byte parity for the raw NCCS BMF assets.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Verify raw NCCS BMF files against source and S3 sizes.")
