"""
Step 08: Upload NCCS BMF analysis outputs to S3.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload NCCS BMF analysis outputs to S3.")
    ...
    banner("STEP 08 - UPLOAD NCCS BMF ANALYSIS OUTPUTS")
    load_env_from_secrets()
    uploads = [
