"""
Step 09: Upload NCCS efile analysis outputs and metadata to S3.
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Upload NCCS efile analysis outputs to S3.")
    ...
    banner("STEP 09 - UPLOAD NCCS EFILE ANALYSIS OUTPUTS")
    load_env_from_secrets()
