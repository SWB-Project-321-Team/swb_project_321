"""
Run irs_990 ingest steps in order: 01 (index) → 02 (ZIPs to S3) → 03 (parse to staging).

Run from repo root: python python/run_irs_990.py
...
For full control, run the three scripts manually; see ingest/irs_990/README.md.
"""
...
INGEST_990 = PYTHON / "ingest" / "irs_990"
...
def main():
    ...
    for name, script in [
        ...
        if rc != 0:
            ...
            sys.exit(rc)
    print("irs_990 pipeline (01 → 02 → 03) completed.")
