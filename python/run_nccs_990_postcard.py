"""
Run the NCCS e-Postcard pipeline in order: 01 -> 06.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run the NCCS e-Postcard pipeline (01 -> 06).")
    ...
    print("NCCS e-Postcard pipeline (01 -> 06) completed.", flush=True)
